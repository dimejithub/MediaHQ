...
export default function Login() {
  ...
  useEffect(() => {
    // Check for session ID in URL (from Google OAuth callback)
      ...
      <div className="w-full max-w-md p-8 space-y-8">
        <div className="text-center">
          <div className="inline-flex items-center gap-3 mb-6">
            <div className="w-14 h-14 rounded-xl bg-white flex items-center justify-center text-slate-900 font-bold text-xl shadow-lg">TEN</div>
        ...
        <div className="space-y-4">
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white text-slate-900 rounded-lg font-medium hover:bg-slate-100 transition-all shadow-lg"
          >
          ...
          <button
            ...
            className="w-full px-6 py-3 bg-slate-800 text-white border border-slate-700 rounded-lg font-medium hover:bg-slate-700 transition-all"
          >
            🎮 Try Demo Mode
          </button>
        </div>
