      ...
      <div className="w-full max-w-md p-8 space-y-8 relative z-10">
        ...
        <div className="space-y-4 animate-fadeInUp stagger-2">
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-slate-900 rounded-xl font-medium hover:bg-slate-100 transition-all shadow-lg hover-lift btn-animate group"
          >
